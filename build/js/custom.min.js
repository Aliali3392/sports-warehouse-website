...
$(function(){
  ...
  //Activate the jQuery Validation plugin for our form
  $("#contact-form").validate({
    ...
    messages:{
      ...
      question:{
        ...
        minlength: "4 or more characters."
      },
    }
  });
  ...
  //admin login
  $("#admin-login-form").attr("novalidate", "");
  ...
  //create new account
  $("#create-account").attr("novalidate", "");
